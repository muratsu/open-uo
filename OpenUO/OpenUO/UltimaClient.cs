...
using OpenUO.Network.Packets.Client;
using OpenUO.Network.Packets.Server;
using OpenUO.Entity;
...
namespace OpenUO
{
    class UltimaClient
    {
        ...
        private static void receive_MobileMoving(IRecvPacket packet)
        {
            ...
            mobile.IsHidden = p.Flags.IsHidden;
            mobile.Notoriety = p.Notoriety;
            // Issue 16 - Pet not showing at login - http://code.google.com/p/OpenUO/issues/detail?id=16 - Smjert
