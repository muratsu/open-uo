...
namespace OpenUO.UltimaData
{
    ...
    public sealed class BodyConverter
    {
		...
		// Issue 6 - Missing mounted animations - http://code.google.com/p/OpenUO/issues/detail?id=6 - Smjert
		// MountItemID , BodyID
    ...
    public sealed class AnimationsXNA
    {
        ...
        private static void getIndexes(ref int body, ref int hue, int action, int direction, out int index, out FileIndex fileIndex)
        {
            ...
            switch (fileType)
            {
                ...
                // Issue 60 - Missing (or wrong) object animations - http://code.google.com/p/OpenUO/issues/detail?id=60 - Smjert
                case 5:
                    {
